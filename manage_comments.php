                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <p class="text-muted mb-2">
                                                    <i class="fas fa-envelope me-2"></i><?= htmlspecialchars($comment['email']) ?>
                                                </p>
                                                
                                                <p class="text-muted mb-2">
                                                    <i class="far fa-calendar me-2"></i><?= formatDate($comment['created_at']) ?>
                                                </p>
                                                
                                                <p class="mb-2">
                                                    <strong><i class="fas fa-newspaper me-2"></i>Article:</strong>
                                                    <a href="../article.php?slug=<?= htmlspecialchars($comment['post_slug']) ?>" 
                                                       target="_blank">
                                                        <?= htmlspecialchars($comment['post_title']) ?>
                                                    </a>
                                                </p>
                                                
                                                <div class="comment-message-admin p-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="action-buttons">
                                                    <?php if ($comment['status'] === 'pending'): ?>
                                                        <a href="?action=approve&id=<?= $comment['id'] ?>" 
                                                           class="btn btn-success w-100 mb-2">
                                                            <i class="fas fa-check me-2"></i>Approuver
                                                        </a>
                                                    <?php else: ?>
                                                        <a href="?action=reject&id=<?= $comment['id'] ?>" 
